...
# Приложения установленные к проекту
THIRD_PARTY_APPS = [
    'rest_framework',
    'corsheaders',
    'django_filters',
...
ROOT_URLCONF = 'best_house_prg.urls'
...
WSGI_APPLICATION = 'best_house_prg.wsgi.application'
...
# Для тестирования без реального SMTP
if DEBUG is True:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    # Или для файлового бэкенда:
    ...
    EMAIL_PORT = 587
    EMAIL_USE_TLS = True
    EMAIL_HOST_USER = 'noreply@besthouse.ru'
    EMAIL_HOST_PASSWORD = 'your-password'
    DEFAULT_FROM_EMAIL = 'noreply@besthouse.ru'
    CONTACT_EMAIL = 'info@besthouse.ru'
