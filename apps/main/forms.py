...
class ConsultingForm(forms.Form):
    ...
    phone_number = forms.CharField(label="Phone", max_length=50, required=True, 
                                   validators=[RegexValidator(regex=r'^\+?1?\d{9,15}$', message='Input correct phone number')], 
    ...
    description = forms.CharField(label="Description", max_length=4000, required=False, 
                                  widget=forms.Textarea(attrs={"class": "form-control", "placeholder": "Ask a question or describe your project"}))
...
class CalculatingProjectForm(forms.Form):
    ...
    room_type = forms.ChoiceField(label="Room type", 
                                  choices=[("Type 1", "Тип 1"), ("Type 2", "Тип 2"), ("Type 3", "Тип 3"), ("Type 4", "Тип 4"), 
                                           ("Type 5", "Тип 5"), ("Type 6", "Тип 6"), ("Type 7", "Тип 7"), ("Type 8", "Тип 8")],
                                           required=True, widget=forms.SelectMultiple(attrs={"class": "form-control", "size": "4"}))
